...
public class Swordmaster extends AbstractMillager {
    ...
    protected void addAdditionalSaveData(@NonNull ValueOutput valueOutput) {
        ...
        valueOutput.putBoolean("respawned",this.isRespawned());
        valueOutput.putBoolean("Invulnerable",this.isRespawned() || this.isInvulnerable());
        valueOutput.putBoolean("isShielding",this.isShielding());
        valueOutput.putInt("invulnerableTicks",this.getInvulnerableTicks());
        valueOutput.putInt("shieldedTimes",this.getShieldedTimes());
        valueOutput.putInt("shieldedCooldown",this.getShieldedCooldown());
    }
    ...
    protected void readAdditionalSaveData(@NonNull ValueInput valueInput) {
        ...
        this.setRespawned(valueInput.getBooleanOr("respawned",false));
        this.setShielding(valueInput.getBooleanOr("isShielding",false));
        this.setInvulnerableTicks(valueInput.getIntOr("invulnerableTicks",0));
        this.setShieldedTimes(valueInput.getIntOr("shieldedTimes",0));
        this.setShieldedCooldown(valueInput.getIntOr("shieldedCooldown",0));
    }
        ...
        if (ticks > 0) {
            ...
            for (LivingEntity target : targets) {
                if (!(target instanceof Player player && (player.isSpectator() || player.isCreative()))) {
                    ...
                    target.knockback(0.5, -dx, -dz, this.damageSources().generic(), 0);
