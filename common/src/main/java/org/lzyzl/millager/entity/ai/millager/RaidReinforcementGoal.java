...
public class RaidReinforcementGoal extends Goal {
    ...
    private static final UUID SPEED_ID = UUID.fromString("74450c18-f4d2-4392-9f5a-0e2f0f50f8cb");
    ...
    private void updateSpeedModifier() {
        this.acceleratedEntity = MiscHelper.updateMillagerSpeedModifier(this.millager, this.acceleratedEntity,
                SPEED_ID, "millager:raid_reinforcement_speed");
    }
