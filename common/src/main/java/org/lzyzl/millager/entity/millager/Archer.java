...
public class Archer extends AbstractMillager implements RangedAttackMob {
    ...
    protected void readAdditionalSaveData(@NonNull ValueInput valueInput) {
        ...
        this.setCrafting(valueInput.getBooleanOr("isCrafting",false));
        this.setCraftingTicks(valueInput.getIntOr("craftingTicks",0));
        this.setCraftCooldown(valueInput.getIntOr("craftCooldown",0));
    }
    ...
    public SpawnGroupData finalizeSpawn(
            ServerLevelAccessor level, @NonNull DifficultyInstance difficulty, @NonNull EntitySpawnReason entitySpawnReason, @Nullable SpawnGroupData spawnGroupData
    ) {
    ...
    @Override
    public void pickUpItem(@NonNull ServerLevel serverLevel, ItemEntity itemEntity) {
