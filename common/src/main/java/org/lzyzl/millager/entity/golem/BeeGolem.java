...
public class BeeGolem extends AbstractGolem {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(1, new BeeGolemNearestTargetGoal<>(this, Mob.class, 5, true, true, (entity, _) -> MillagerTargetingHelper.canBeeGolemAttack(entity)));
