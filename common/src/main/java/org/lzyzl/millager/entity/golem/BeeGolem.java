...
public class BeeGolem extends AbstractGolem implements FlyingAnimal {
    ...
    protected @NonNull PathNavigation createNavigation(@NonNull Level level) {
        FlyingPathNavigation nav = new BeeGolemPathNavigation(this, level);
    ...
    public void readAdditionalSaveData(@NonNull CompoundTag valueInput) {
        ...
        this.setLifeTicks(valueInput.getInt("lifeTicks"));
    ...
    private static class BeeGolemPathNavigation extends FlyingPathNavigation {
        private BeeGolemPathNavigation(BeeGolem beeGolem, Level level) {
            super(beeGolem, level);
        }
