...
public class DoctorFlyEscapeGoal extends Goal {
    ...
    public boolean canUse() {
        LivingEntity living = this.doctor.getLastHurtByMob();
    ...
    public void start() {
        ...
        if (this.doctor.level() instanceof ServerLevel serverLevel) {
            serverLevel.sendParticles(ParticleTypes.POOF, this.doctor.getX(), this.doctor.getY(), this.doctor.getZ(), 10, 0.3, 0.3, 0.3, 0.05);
        }
    }
}
