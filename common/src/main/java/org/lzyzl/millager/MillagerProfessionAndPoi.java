...
public class MillagerProfessionAndPoi {
    ...
    private static ResourceKey<TradeSet> commanderTrades(int level) {
        return ResourceKey.create(Registries.TRADE_SET,
                Identifier.fromNamespaceAndPath(MOD_ID, "commander/level_" + level));
    }
    ...
    public static final DeferredHolder<VillagerProfession, VillagerProfession> COMMANDER = PROFESSIONS.register(
            ...
            () -> new VillagerProfession(
                    ...
                    Int2ObjectMap.ofEntries(
                            Int2ObjectMap.entry(1, commanderTrades(1)),
                            Int2ObjectMap.entry(2, commanderTrades(2)),
                            Int2ObjectMap.entry(3, commanderTrades(3)),
                            Int2ObjectMap.entry(4, commanderTrades(4)),
                            Int2ObjectMap.entry(5, commanderTrades(5))
                    )
            )
    );
