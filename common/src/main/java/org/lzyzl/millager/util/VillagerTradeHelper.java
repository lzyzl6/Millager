...
public class VillagerTradeHelper {
    ...
    public static final ResourceKey<VillagerProfession> FARMER_KEY =
            ResourceKey.create(Registries.VILLAGER_PROFESSION, ResourceLocation.fromNamespaceAndPath("minecraft", "farmer"));
    public static final ResourceKey<VillagerProfession> SHEPHERD_KEY =
            ResourceKey.create(Registries.VILLAGER_PROFESSION, ResourceLocation.fromNamespaceAndPath("minecraft", "shepherd"));
    ...
    private static void registerShepherdTrades(BiConsumer<Integer, VillagerTrades.ItemListing> sink) {
        sink.accept(5, (entity, random) -> new MerchantOffer(
                ...
                VillageBannerHelper.create(entity.registryAccess().lookupOrThrow(Registries.BANNER_PATTERN)),
                12, 30, 0.05f
        ));
    }
    ...
    private static void registerCommanderTrades(BiConsumer<Integer, VillagerTrades.ItemListing> sink) {
        ...
        sink.accept(1, (entity, random) -> {
            ...
            return new MerchantOffer(
                    ...
                    MiscHelper.createExplorerMap("pillager_outpost", ON_OUTPOST_EXPLORER_MAPS, MapDecorationTypes.TARGET_POINT, serverLevel, entity),
                    3, 1, 0.2f
            );
        });
