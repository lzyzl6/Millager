...
public abstract class GuiEntityRendererMixin {
    ...
    private void millager$renderPreviewSafely(GuiEntityRenderState state, PoseStack poseStack, SubmitNodeCollector collector,
                                              Operation<Void> original) throws Throwable {
        boolean targetScreen = Minecraft.getInstance().gui.screen() instanceof MillagerTargetConfigScreen;
