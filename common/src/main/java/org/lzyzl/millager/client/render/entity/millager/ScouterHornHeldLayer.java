...
public class ScouterHornHeldLayer extends RenderLayer<Scouter, MillagerModel<Scouter>> {
    ...
    @Override
    public void render(PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, Scouter entity, float limbSwing, float limbSwingAmount, float partialTick, float ageInTicks, float netHeadYaw, float headPitch) {
