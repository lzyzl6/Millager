...
public class HeadBlockRenderer implements BlockEntityRenderer<HeadBlockEntity> {
    ...
    public static final Map<SkullBlock.Type, ResourceLocation> SKIN_BY_TYPE = Util.make(Maps.newHashMap(), (hashMap) -> {
        hashMap.put(AbstractHeadBlock.MillagerTypes.VILLAGER, ResourceLocationHelper.create(MOD_ID, "textures/entity/villager/villager.png"));
        hashMap.put(AbstractHeadBlock.MillagerTypes.ILLAGER, ResourceLocationHelper.create(MOD_ID, "textures/entity/illager/pillager.png"));
    });
    ...
    public static RenderType getSkullRenderType(SkullBlock.Type type) {
        ...
        return RenderType.entityCutoutNoCullZOffset(Objects.requireNonNullElseGet(id, () -> ResourceLocationHelper.create("minecraft", "textures/entity/skeleton/skeleton.png")));
    }

    @Override
    public void render(HeadBlockEntity entity, float partialTick, @NonNull PoseStack poseStack, @NonNull MultiBufferSource buffer, int packedLight, int packedOverlay) {
