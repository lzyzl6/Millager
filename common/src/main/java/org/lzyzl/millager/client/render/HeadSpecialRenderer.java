...
public class HeadSpecialRenderer implements NoDataSpecialModelRenderer {
    ...
    public void submit(@NonNull ItemDisplayContext itemDisplayContext, @NonNull PoseStack poseStack, @NonNull SubmitNodeCollector submitNodeCollector, int i, int j, boolean bl, int k) {
