...
public final class MillagerConfigScreen extends Screen {
    ...
    private void rebuild() {
        ...
        if (this.category == Category.MISC && this.page == 0) {
            this.targetButton = addRenderableWidget(Button.builder(Component.empty(),
                    ignored -> this.minecraft.gui.setScreen(new MillagerTargetConfigScreen(this, this.data)))
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
        ...
        if (this.targetButton != null) {
            ...
            graphics.text(this.font, Component.translatable("millager.config.option.misc.target_relations.name"),
        ...
        graphics.centeredText(this.font, Component.literal((this.page + 1) + " / " + this.pageCount), this.width / 2, this.height - 46, 0xFFA0A0A0);
        if (this.error != null) {
