...
public class RioterShieldBackLayer extends RenderLayer<Rioter, MillagerModel<Rioter>> {
    ...
    @Override
    public void render(@NonNull PoseStack poseStack, @NonNull MultiBufferSource bufferSource, int packedLight, Rioter entity, float limbSwing, float limbSwingAmount, float partialTick, float ageInTicks, float netHeadYaw, float headPitch) {
