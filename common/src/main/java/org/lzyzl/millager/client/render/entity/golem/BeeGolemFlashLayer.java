...
public class BeeGolemFlashLayer extends RenderLayer<BeeGolem, BeeGolemModel> {
    ...
    private static final ResourceLocation FLASH_TEXTURE = ResourceLocation.fromNamespaceAndPath(MOD_ID, "textures/entity/golem/bee_golem_flash.png");
    ...
    @Override
    public void render(PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, BeeGolem entity, float limbSwing, float limbSwingAmount, float partialTick, float ageInTicks, float netHeadYaw, float headPitch) {
