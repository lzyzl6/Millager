...
public class TradingHallStructure extends Structure {
    ...
    public static final Codec<TradingHallStructure> CODEC = RecordCodecBuilder.create(instance -> instance.group(settingsCodec(instance)).apply(instance, TradingHallStructure::new));
