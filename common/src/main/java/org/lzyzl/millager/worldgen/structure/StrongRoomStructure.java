...
public class StrongRoomStructure extends Structure {
    ...
    public static final MapCodec<StrongRoomStructure> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(settingsCodec(instance)).apply(instance, StrongRoomStructure::new));
