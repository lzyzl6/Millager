...
public class TradingHallPiece extends TemplateStructurePiece {
    ...
    private static final ResourceLocation STRUCTURE = ResourceLocationHelper.create(MOD_ID, "trading_hall");

    public TradingHallPiece(StructureTemplateManager manager, CompoundTag tag) {
        super(MillagerStructures.TRADING_HALL_PIECE.get(), tag, manager, id -> makeSettings(tag.contains("rot") ? Rotation.valueOf(tag.getString("rot")) : Rotation.NONE));
    }
