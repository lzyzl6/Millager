...
public class FloatingIslandStructure extends Structure {
    ...
    public static final MapCodec<FloatingIslandStructure> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(settingsCodec(instance)).apply(instance, FloatingIslandStructure::new));
