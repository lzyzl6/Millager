...
public class CommandPostStructure extends Structure {
    ...
    public static final MapCodec<CommandPostStructure> CODEC = RecordCodecBuilder.mapCodec((instance) -> instance.group(settingsCodec(instance), Codec.BOOL.fieldOf("ruined").forGetter((commandPostStructure) -> commandPostStructure.ruined)).apply(instance, CommandPostStructure::new));
