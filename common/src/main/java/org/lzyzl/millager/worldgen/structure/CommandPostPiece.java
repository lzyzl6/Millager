...
public class CommandPostPiece extends TemplateStructurePiece {
    ...
    private static final TagKey<Biome> IS_DESERT =
            TagKey.create(Registries.BIOME, ResourceLocationHelper.create("c", "desert"));

    private static final TagKey<Biome> FORGE_IS_DESERT =
            TagKey.create(Registries.BIOME, ResourceLocationHelper.create("forge", "is_desert"));

    private static final TagKey<Biome> HAS_DESERT_PYRAMID =
            TagKey.create(Registries.BIOME, ResourceLocationHelper.create("minecraft", "has_structure/desert_pyramid"));

    private static final ResourceLocation[] STRUCTURES_NORMAL = new ResourceLocation[]{
            ResourceLocationHelper.create(MOD_ID, "command_post/classic")
    };
    private static final ResourceLocation[] STRUCTURES_DESERT = new ResourceLocation[]{
            ResourceLocationHelper.create(MOD_ID, "command_post/sand")
    };
    private static final ResourceLocation[] STRUCTURES_RUINED = new ResourceLocation[]{
            ResourceLocationHelper.create(MOD_ID, "command_post/ruined_classic")
    };
    private static final ResourceLocation[] STRUCTURES_DESERT_RUINED = new ResourceLocation[]{
            ResourceLocationHelper.create(MOD_ID, "command_post/ruined_sand")
    };
    public final boolean ruined;
    public final int embedDepth;

    public CommandPostPiece(StructureTemplateManager manager, CompoundTag tag) {
        super(MillagerStructures.COMMAND_POST_PIECE.get(), tag, manager,
