...
public class MillagerItems {
    ...
    private static final FoodProperties LIQUOR = new FoodProperties.Builder()
            .nutrition(3).saturationMod(0.1F).alwaysEat().build();
    ...
    public static final DeferredItem<SpawnEggItem> BEE_GOLEM_SPAWN_EGG = ITEMS.registerSpawnEgg(
            "bee_golem_spawn_egg", MillagerEntityTypes.Bee_Golem, 15582019, 14071391, Item.Properties::new);

    public static final DeferredItem<SpawnEggItem> DOCTOR_SPAWN_EGG = ITEMS.registerSpawnEgg(
            "doctor_spawn_egg", MillagerEntityTypes.Doctors, 5651507, 14254722, Item.Properties::new);

    public static final DeferredItem<SpawnEggItem> ARCHER_SPAWN_EGG = ITEMS.registerSpawnEgg(
            "archer_spawn_egg", MillagerEntityTypes.Archers, 5651507, 14262383, Item.Properties::new);
    ...
    public static final DeferredItem<SpawnEggItem> SCOUTER_SPAWN_EGG = ITEMS.registerSpawnEgg(
            "scouter_spawn_egg", MillagerEntityTypes.Scouters, 5651507, 11635401, Item.Properties::new);
